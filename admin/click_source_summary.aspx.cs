...
namespace com.hujun64.admin
{
    ...
    /// </summary>
    public partial class click_source_summary : AdminPageBase
    {



        private IClientService clientService = ServiceFactory.GetClientService();
        private int defaultPeriodDays = 0;
        ...
        private void listBind()
        {
            ...
            DataSet ds = clientService.SummaryClickSource(summaryDateFrom, summaryDateTo);
